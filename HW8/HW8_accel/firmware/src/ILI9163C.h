...
void display_character(unsigned char c, short x, short y, int color); // display a single character
void display_string(unsigned char * msg, short x, short y, int color); // display a string of characters
void draw_bar(short x, short y, int color, short len, short w); // draw a progress solid bar
